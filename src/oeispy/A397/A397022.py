...
def a(n, piece=frozenset({(0,0),(1,0),(1,1),(2,1)})):
    ...
    return len(states)
print([a(n) for n in range(1, 6)])  # 1, 16, 378, 12882, 472871
# larger terms by the parallel hash-sharded on-disk method.
